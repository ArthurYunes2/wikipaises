...
git clone https://github.com/SEU_USUARIO/wikipaises.git
cd wikipaises
...
Este projeto foi desenvolvido com auxílio do Claude (Anthropic). Os prompts utilizados foram:

**Prompt 1:** *(cole aqui o prompt que você usou)*  
**Resposta:** *(cole aqui a resposta)*

> Conforme exigido pelo professor, todos os prompts e respostas estão documentados no PDF de submissão.

## 📄 Deploy

Aplicação publicada em: **[link aqui]**
